    ...
    <section id="about" className="py-24 md:py-48 px-6 md:px-12 lg:px-24 bg-brand-gray relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-24 md:mb-32">
          <div className="md:w-1/3">
             <Reveal>
                ...
                {t('about.title')} <span className="text-brand-accent text-lg align-top ml-2">{t('about.number')}</span>
                </h2>
             </Reveal>
          </div>
          <div className="md:w-2/3">
            <Reveal delay={0.2}>
                <p className="text-lg md:text-2xl text-white/90 font-light leading-relaxed mb-8" dangerouslySetInnerHTML={{ __html: t('about.philosophy') }}>
                </p>
            </Reveal>
            <Reveal delay={0.3}>
        ...
        <div className="border-t border-white/10 pt-16 md:pt-24">
            <Reveal>
                <h3 className="text-lg font-mono text-brand-accent mb-12 uppercase tracking-widest">{t('about.experience')}</h3>
            </Reveal>
