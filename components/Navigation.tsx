    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <button
            onClick={toggleMenu}
            className={`md:hidden text-white pointer-events-auto focus:outline-none transition-opacity duration-300 ${isOpen ? 'opacity-0' : 'opacity-100'}`}
          ...
          >
            ...
            <div className="flex justify-between items-start p-6 relative z-10">
                ...
                >
                    ...
                    <div className="relative z-10 bg-white/10 p-1.5 rounded-full group-hover:bg-white/20 transition-colors">
                        <Zap size={14} className="text-brand-accent group-hover:text-white transition-colors" fill="currentColor" />
                    </div>
            ...
            <div className="flex-1 flex flex-col justify-center items-center relative z-10">
                ...
                {NAV_ITEMS.map((item, index) => (
                    ...
                    transition={{ delay: 0.3 + index * 0.1, ease: [0.22, 1, 0.36, 1], duration: 0.8 }}
                    onClick={(e) => handleNavClick(e, item.href)}
